...
public class CustomerServiceHelper {
    public static Employee getEmployee(EmployeeRepository userRepository, ProcessUserIdGetter processUseridGetter){
        return userRepository.getEmployee(processUseridGetter.get()).orElseThrow(UserNotFoundException::new);
    }
