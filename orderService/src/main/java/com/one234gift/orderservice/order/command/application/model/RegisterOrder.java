package com.one234gift.orderservice.order.command.application.model;
...
public class RegisterOrder {
    ...
    @Builder
    public RegisterOrder(String product, Long customerId, String delivery, long quantity, long purchasePrice, long salePrice, String content, OrderType type) {
